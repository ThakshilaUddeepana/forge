                ...
                <div className="relative z-10 max-w-7xl mx-auto px-8 w-full pt-20">
                    <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
                        ...
                        <div className="flex flex-wrap items-center gap-4 pt-4">
                            <Link
                                to="/customize"
                                className="group flex items-center gap-2 px-8 py-5 text-lg font-bold text-white bg-orange-600 rounded-full hover:bg-orange-500 transition-all shadow-xl shadow-orange-600/20 active:scale-95"
                            >
                                CUSTOMIZE T-SHIRTS
                            ...
                            <Link
                                to="/catalog"
                                className="group flex items-center gap-2 px-8 py-5 text-lg font-bold text-white/80 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:text-white transition-all active:scale-95"
                            >
                                VIEW COLLECTIONS
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center gap-8 pt-12 border-t border-white/10">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Eco-Materials</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-8 relative z-10">
                    <div className="text-center space-y-4 mb-20 text-balance">
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight">WHY CHOOSE FORGE?</h2>
